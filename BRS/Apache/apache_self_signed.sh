...
sudo echo Safe Page > /var/www/htmls/index.html

sudo rm /var/www/html/index.html
sudo echo Unsafe Page > /var/www/html/index.html

sudo cp /etc/ssl/certs/ca.crt /var/www/html
sudo chmod 777 /var/www/html/ca.crt
